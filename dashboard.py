...
rec_css  = {"BUY": "rec-buy", "HOLD": "rec-hold", "SELL": "rec-sell"}[action]
rec_icon = {"BUY": "📈", "HOLD": "⏸️", "SELL": "📉"}[action]
 
st.markdown(
    f'<div class="recommendation-box {rec_css}">'
    f'<div class="rec-title">{rec_icon} {action}</div>'
